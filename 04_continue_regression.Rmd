...
Given all of the above plots, in particular the posterior predictive test of how well our model reproduces the median value of the observed, it appears that while this model does slightly better job at approximating our data than our earlier model it still fails are adequately representing our data. We are failing to reproduce the multi-modality of the data. What could we do to improve our model?
